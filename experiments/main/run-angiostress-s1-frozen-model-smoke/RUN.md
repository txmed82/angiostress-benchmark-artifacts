...
- Worktree: `.ds/worktrees/run-angiostress-s1-frozen-model-smoke`
- Idea: `idea-a229721e`
...
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/RUN.md`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/VALIDATION.md`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/DEPENDENCY_AUDIT.md`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/run_sam_smoke.py`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/outputs/manifest.json`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/outputs/metrics_summary.json`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/outputs/per_cell_metrics.csv`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/outputs/predictions/clean_mask.png`
- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/outputs/predictions/device_overlay_severity_2_mask.png`

## Config Paths

- `.ds/worktrees/run-angiostress-s1-frozen-model-smoke/experiments/main/run-angiostress-s1-frozen-model-smoke/config.json`

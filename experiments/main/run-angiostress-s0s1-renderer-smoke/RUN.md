...
- Worktree: `.ds/worktrees/idea-idea-a229721e`
- Idea: `idea-a229721e`
...
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/VALIDATION.md`
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/run_renderer_smoke.py`
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/outputs/manifest.json`
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/outputs/metrics_summary.json`
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/outputs/clean_preview.png`
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/outputs/cells/device_overlay_severity_2.png`
- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/outputs_rerun_check/manifest.json`

## Config Paths

- `.ds/worktrees/idea-idea-a229721e/experiments/main/run-angiostress-s0s1-renderer-smoke/config.json`
